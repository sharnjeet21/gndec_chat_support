...
content = content.replace("# ============================\n# SYNC RESPONSE", helper + "# SYNC RESPONSE")

sync_replace = """    if await asyncio.to_thread(is_out_of_domain, query):
...
stream_replace = """    if await asyncio.to_thread(is_out_of_domain, query):
